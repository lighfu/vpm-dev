Shader "AjisaiAR/Locked_0524a5e3"
{
    Properties
    {
        // ── AjisaiAR injection ──
    ...
    SubShader
    {
        ...
        UsePass "Hidden/ltspass_arlocked_ltspass_cutout_0524a5e3/FORWARD"
        UsePass "Hidden/ltspass_arlocked_ltspass_cutout_0524a5e3/FORWARD_ADD"
        UsePass "Hidden/ltspass_arlocked_ltspass_cutout_0524a5e3/SHADOW_CASTER"
        UsePass "Hidden/ltspass_arlocked_ltspass_cutout_0524a5e3/META"
        Pass
        {
