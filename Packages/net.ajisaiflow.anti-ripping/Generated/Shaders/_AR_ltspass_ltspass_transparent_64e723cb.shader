Shader "Hidden/ltspass_arlocked_ltspass_transparent_64e723cb"
{
    Properties
    {
            ...
            #define OVERRIDE_MAIN \
                ...
                { \
                    ...
                    { \
                        ...
                        /* (sx, sy) を 13-bit packed から復元: R=sx[12..5], G=sx[4..0]<<3|sy[12..10], B=sy[9..2], A=sy[1..0]<<6|lowR<<4|lowG<<2|lowB */ \
