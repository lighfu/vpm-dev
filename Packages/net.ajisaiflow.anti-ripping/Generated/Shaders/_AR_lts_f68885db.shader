Shader "AjisaiAR/Locked_f68885db"
{
    Properties
    {
        // ── AjisaiAR injection ──
    ...
    SubShader
    {
        ...
        UsePass "Hidden/ltspass_arlocked_ltspass_opaque_f68885db/FORWARD"
        UsePass "Hidden/ltspass_arlocked_ltspass_opaque_f68885db/FORWARD_ADD"
        UsePass "Hidden/ltspass_arlocked_ltspass_opaque_f68885db/SHADOW_CASTER"
        UsePass "Hidden/ltspass_arlocked_ltspass_opaque_f68885db/META"
        Pass
        {
