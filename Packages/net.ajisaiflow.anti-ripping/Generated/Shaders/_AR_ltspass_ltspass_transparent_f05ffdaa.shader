Shader "Hidden/ltspass_arlocked_ltspass_transparent_f05ffdaa"
{
    Properties
    {
    ...
    SubShader
    {
        HLSLINCLUDE
            ...
            // 波模様 fix: mapping sample 前に UV を texel center に snap (GPU sampler vs shader cast の精度差排除)
            #define OVERRIDE_MAIN \
                ...
                { \
                    ...
                    { \
                        ...
                        /* snap UV to texel center → mapping sampler returns exact texel matching shader pix */ \
                        float2 _ar_uvs_m = (float2(_ar_pix) + 0.5) * _MainTex_TexelSize.xy; \
                        float4 _ar_msmp = LIL_SAMPLE_2D_LOD(_AR_MainTexMapping, sampler_AR_MainTexMapping, _ar_uvs_m, 0); \
