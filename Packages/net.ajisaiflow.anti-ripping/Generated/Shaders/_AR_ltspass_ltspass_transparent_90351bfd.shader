Shader "Hidden/ltspass_arlocked_ltspass_transparent_90351bfd"
{
    Properties
    {
    ...
    SubShader
    {
        HLSLINCLUDE
            ...
            // OVERRIDE_MAIN (Value XOR Color): lilToon の sample 直後 (lighting 前) に decode を inject。
            ...
            #define OVERRIDE_MAIN \
                ...
                { \
                    ...
                    if (_ar_seed_c != 0u) \
                    { \
                        fd.col.rgb = _AR_DecodePixelRGB(fd.col.rgb, fd.uvMain, _ar_seed_c, _MainTex_TexelSize.zw); \
                    } \
                } \
