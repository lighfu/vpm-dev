Shader "Hidden/ltspass_arlocked_ltspass_transparent_0f5b9fc3"
{
    Properties
    {
            ...
            #define OVERRIDE_MAIN \
                ...
                { \
                    ...
                    { \
                        ...
                        float4 _ar_msmp = tex2Dlod(_AR_MainTexMapping, float4(_ar_mu, 0, 0)); \
                        ...
                        float4 _ar_smp = tex2Dlod(_MainTex, float4(_ar_su, 0, 0)); \
