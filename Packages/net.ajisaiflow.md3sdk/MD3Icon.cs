...
namespace AjisaiFlow.MD3SDK.Editor
{
    ...
    /// Provides icon codepoint constants and a factory to create icon Labels
    /// with the Material Symbols Outlined font applied.
    /// </summary>
    public static class MD3Icon
    {
        static Font s_font;
        ...
        public const string AppSpark = "\udbbf\udf82";
        ...
        public const string CreateIcon = "\uf097";
        ...
        public const string FitbitRaquetball = "\udbbf\udfc5";
        ...
        public const string FrameSpark = "\udbbf\udf81";
        ...
        public const string TranslateCc = "\udbbf\udf80";
        public const string TranslateIndic = "\uf263";
        public const string TranslateSubtitles = "\udbbf\udf7f";
        ...
        public const string YoutubeActivity2 = "\udbbf\udf84";
        public const string YoutubeSearchedFor = "\ue8fa";
        public const string YoutubeVideo = "\udbbf\udf83";
        ...
        /// <summary>
        /// Creates a Label displaying a Material Symbols icon.
        /// </summary>
        public static Label Create(string iconCodepoint, float size = 20f, Color? color = null)
        {
            var label = new Label(iconCodepoint);
        ...
        /// <summary>
        /// Applies the Material Symbols font to an existing VisualElement.
        /// </summary>
        public static void Apply(VisualElement element, float size = 20f)
        {
            EnsureFont();
            if (s_fontAsset != null)
                element.style.unityFontDefinition = new StyleFontDefinition(s_fontAsset);
            else if (s_font != null)
        ...
        /// <summary>
        /// Converts an icon name (e.g. "home") to its codepoint string by lookup.
        /// For performance-critical paths, use the const fields directly.
        /// </summary>
        public static string FromName(string iconName)
        {
            // Use reflection-free lookup of the const fields via a simple codepath file parse
            // For common use, the const fields above are preferred
            var codepointsGuids = AssetDatabase.FindAssets("MaterialSymbolsOutlined t:TextAsset");
            foreach (var guid in codepointsGuids)
            {
                ...
                foreach (var line in asset.text.Split('\n'))
                {
                    ...
                    if (trimmed.Substring(0, spaceIdx) == iconName)
                    {
                        var hex = trimmed.Substring(spaceIdx + 1).Trim();
        ...
        static FontAsset s_filledFontAsset;

        /// <summary>
        /// Creates a filled (FILL=1) icon Label. Uses MaterialSymbolsOutlinedFilled.ttf.
        /// </summary>
        public static Label CreateFilled(string iconCodepoint, float size = 20f, Color? color = null)
        {
            var label = new Label(iconCodepoint);
            label.pickingMode = PickingMode.Ignore;
            ApplyFilled(label, size);
            if (color.HasValue)
                label.style.color = color.Value;
            return label;
        }
        ...
        /// <summary>
        /// Applies the filled Material Symbols font to an existing VisualElement.
        /// </summary>
        public static void ApplyFilled(VisualElement element, float size = 20f)
        {
            EnsureFilledFont();
            if (s_filledFontAsset != null)
                element.style.unityFontDefinition = new StyleFontDefinition(s_filledFontAsset);
            else if (s_filledFont != null)
